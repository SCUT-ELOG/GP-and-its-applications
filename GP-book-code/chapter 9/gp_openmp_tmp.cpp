...
int post_size_max = 0;
 ...
 int main() {
    ...
    srand(0);
     ...
     clock_t start, end;
     clock_t tstart, tend;
     float time_0 = 0, time_1 = 0, time_2 = 0, time_3 = 0;

     start = clock();
     tstart = start;
    gettimeofday(&st_tv, &st_tz);
    ...
    gettimeofday(&ed_tv, &ed_tz);
    time_0 = double((ed_tv.tv_sec - st_tv.tv_sec) * 1000000 + (ed_tv.tv_usec - st_tv.tv_usec)) / 1000000;
     delete ret_init;
     aver_message.aver_size_post /= POPULATION;
     cout << "<<========================================Initialization: " << double(end - start) / CLOCKS_PER_SEC << ' ' << double((ed_tv.tv_sec - st_tv.tv_sec) * 1000000 + (ed_tv.tv_usec - st_tv.tv_usec)) / 1000000 << ", average post size: " << aver_message.aver_size_post << endl;
    ...
    tstart = start;
     ...
     for (int i = 0; i < GENERATION; ++i) {
        ...
        gettimeofday(&ed_tv, &ed_tz);
        time_1 += double((ed_tv.tv_sec - st_tv.tv_sec) * 1000000 + (ed_tv.tv_usec - st_tv.tv_usec)) / 1000000;
        ...
        gettimeofday(&ed_tv, &ed_tz);
        time_2 += double((ed_tv.tv_sec - st_tv.tv_sec) * 1000000 + (ed_tv.tv_usec - st_tv.tv_usec)) / 1000000;
        ...
        gettimeofday(&ed_tv, &ed_tz);
        time_3 += double((ed_tv.tv_sec - st_tv.tv_sec) * 1000000 + (ed_tv.tv_usec - st_tv.tv_usec)) / 1000000;
     }
     
    tend = end;
        
    gettimeofday(&ed_tv, &ed_tz);
    cout << "<<========================================: " << ", time cost: " << time_0 << ", " << time_1 << ", "<< time_2 << ", "<< time_3 << ", " <<  "s, " << double(tend - tstart) / CLOCKS_PER_SEC << ", " << double((ed_tv.tv_sec - st_tv.tv_sec) * 1000000 + (ed_tv.tv_usec - st_tv.tv_usec)) / 1000000 << ", average post size: " << aver_message.aver_size_post << endl;
    exit(0);
